...
<section class="ad a1H a1I[180px] a1J[120px]">
    ...
    <button class="a7 a8 a9 a1x a44 aw dark:a3w[#242B51] a1S hover:a1W dark:a1S aH a1R dark:hover:aI a13 a33 dark:a1n a2E">
    <span class="a2A">
    ...
    <span class=" aj sm:ah aB[70px] a7 at[1px] a3f"></span>
    <p class="a7 a37 a1S a1M aH a1R ">
    ...
    <input type="email" name="email" name="email" placeholder="Enter your Email" class="
                      a7 a3l a3m
                      dark:a3w[#242B51]
                      a13 a33
                      dark:a1n
    ...
    {{-- <input id="email" type="email" name="email" placeholder="Enter your Email" :value="old('email')" class="a7 a3l a3m dark:a3w[#242B51] a13 a33 dark:a1n a1i az a1S aH a3x a3o focus-visible:aE focus:a3p"/> --}}
    </div>
    <div class="a23">
...
Your Password
    ...
    <div>
        ...
        <label for="checkboxLabel" class="
                      ...
                      ">
<div class="ad">
<input type="checkbox" id="checkboxLabel" class="a1B" name="remember"/>
    ...
    <a href="signup.html" class="a1W hover:a2T">
    Sign up
    </a>
    </p>
    </div>
