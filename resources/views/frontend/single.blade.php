...
@section('content')
    <section class="a1I[150px] a1J[120px]">
        <div class="aa">
            <div class="a8 a1K a1x ab[-16px]">
                <div class="a7 lg:a2q/12 ae">
                    ...
                    ">
                            ...
                            a2G
                          ">
                                        <img src="{{ optional($problemInfo->media)->first()->name['url'] ?? 'https://picsum.photos/200?random=' . rand(1, 20) }}"
                                            alt="author" class="a7" />
                          ...
                          ">
                                        ...
                                        {{ Carbon\Carbon::parse($problemInfo->created_at)->format('d M Y') }}
                                    </p>
                                    <p
                                        class="
                            a8
                          ...
                          ">
                                        <span class="a2A">
                                            <svg width="18" height="13" viewBox="0 0 18 13" class="a26">
                                                <path
                          ...
                          ">
                                        <span class="a2A">
                                            <svg width="20" height="12" viewBox="0 0 20 12" class="a26">
                                                <path
                      ...
                      ">
                            ...
                            <div class="coderDairy_single_image" style="display: flex">

                                @foreach ($problemInfo->media as $image)


                                    <div class="a7 a1c a2p a1V single_image" style="margin: 2px">


                                        <img src="{{ $image->name['url'] ?? 'https://picsum.photos/200?random=' . rand(1, 3) }}"
                                        alt="image" class="a7 a2Q a2R a2S" />
                                </div>
                                @endforeach
                        ...
                        a1U a23
                      ">
                                {{ strip_tags($problemInfo->description) }}
                          ...
                          ">
                                    ...
                                    <div class="a8 a9">
                                        @foreach ($problemInfo->tags as $tag)
                          ...
                          ">
                              ...
                              hover:a31 hover:aI
                            ">
                                            <svg width="16" height="16" viewBox="0 0 16 16" class="a26">
                                                <path
                    ...
                    @foreach ($solutions as $index => $solution)
                        <a href="javascript:void(0)"
                         ...
                         <div class="coderDairy_single_image" style="display: flex">
                                ...
                                @foreach ($solution->media as $image)
                                    <div class="a7 a1c a2p a1V single_image" style="margin: 2px">
                                        <img src="{{ $image->name['url'] ?? 'https://picsum.photos/200?random=' . rand(1, 3) }}"
                                        alt="image" class="a7 a2Q a2R a2S" />
                                </div>
