...
@section('content')
                            ...
                            <div class="flex-1">
                                ...
                                <label for="tags" class="formLabel">
                                    ...
                                    <a href="#add_new_tag_dialog"
                                        class="popup-with-move-anim text-teal-600 text-sm ml-5">Add New Tag</a>
                                </label>

                                {{-- <label for="tags" class="formLabel">Tags</label> --}}
                                <div class="flex space-x-2 tag_list">
                                    @foreach ($tags as $tag)
    ...
    {{-- magnefic popup window --}}
    <div id="add_new_tag_dialog" class="zoom-anim-dialog mfp-hide">
        <h1>Add New Tag</h1>
        <p class="text-red-500 my-1" id="tag_msg"></p>
            ...
            if ($(name).val() != '') {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // add to list
                        $('.tag_list').append(
                            '<input checked type="checkbox" id="' + tag.slug + '" name="tags[]" value="' +
                            tag.id + '"><label for="' + tag.slug + '" class="mr-2">' + tag.name +
                            '</label>'
                        )
                        }
